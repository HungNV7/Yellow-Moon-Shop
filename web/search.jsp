<%-- 
    Document   : search
    Created on : Oct 7, 2020, 9:50:20 AM
    Author     : ASUS
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <c:if test="${sessionScope.SEARCH_PRODUCT.size() != 0}">
                    <c:forEach var="product" items="${sessionScope.SEARCH_PRODUCT}">
                        <div class="col-6">
                            <div class="card">
            ...
            <c:if test="${sessionScope.SEARCH_PRODUCT != null}">
                <c:if test="${sessionScope.SEARCH_PRODUCT.size() != 0}">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <li class="page-item">
                                <a class="page-link" href="search?txtName=${param.txtName}&txtPrice=${param.txtPrice}&txtCategory=${param.txtCategory}&page=${requestScope.page}&other=prev" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                            <c:if test="${sessionScope.COUNT_SEARCH != null}">
                                <c:forEach begin="1" end="${sessionScope.COUNT_SEARCH}" varStatus="count">
                                    <li class="page-item"><a class="page-link" href="search?txtName=${param.txtName}&txtPrice=${param.txtPrice}&txtCategory=${param.txtCategory}&page=${count.index}">${count.index}</a></li>
                                    </c:forEach>
                                </c:if>

                            <a class="page-link" href="search?txtName=${param.txtName}&txtPrice=${param.txtPrice}&txtCategory=${param.txtCategory}&page=${requestScope.page}&other=next" aria-label="Next">
