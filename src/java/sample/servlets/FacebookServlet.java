...
public class FacebookServlet extends HttpServlet {
    ...
    private Logger logger = Logger.getLogger(FacebookServlet.class.getName());
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean userExit = userDAO.checkLogin(user.getUserID()) != null;
            if(!userExit){
                userDAO.insert(user);
            }
            ...
            logger.error("Error in FacebookServlet: " + e);
        }finally{
